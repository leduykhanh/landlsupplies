...
$injury =array(
				...
				"1"=>"Drowned (5)",
				"2"=>"Electrocuted (5)",
				"3"=>"Multiple injuries (4)",
				"4"=>"Damaged to property (4)",
				"5"=>"Serious body injuries (4)",
				"6"=>"Heat injury (4)",
				"7"=>"Occupational disease(4)",
				"8"=>"Minor fractures (3)",
				"9"=>"Noise Induced Deafness (3)",
				"10"=>"Musculoskeletal Disorders (3)",
				"11"=>"Sprains (2)",
				"12"=>"Cuts and laceration (2)",
				"13"=>"Skin/Throat irritation (2)",
				"14"=>"Bruises  (1)"
				);
$severity = array(
				"0"=>"5",
...
$existing_risk_control=array(
	...
	"n_p_d_c_p" => array(
		"0" => "Usage of less noisy equipment or tools",
		"1" => "Wearing of ear plugs"
		),
	"p_h_o_w_a" => array(
		"0" => "Regular inspection of work area",
		"1" => "Practice regular housekeeping",
		"2" => "Fire evacuation plan",
		"3" => "Combustible materials to be stored away from fire source" 
		),
	"d_p_c_a_h_a" => array(
		"0" => "Regular inspection of work area",
		"1" => "Practice regular housekeeping",
		"2" => "Water can be sprayed to bring down high dust levels",
		"3" => "Dust masks to be provided to workers"
		),
	"p_m_o_c_m" => array(
		"0" => "Wearing of gloves",
		"1" => "Ensure cutting machine is provided with effective guarding",
		"2" => "Cutting machine to be sent to authorised supplier for maintenance if needed",
		"3" => "Cutter machine to be included in maintenance regime",
		"4" => "Proper maintenance training to be conducted by supervisors",
		"5" => "Pre inspection before the use of the machine"
		),
	"r_a" =>	array(
		"0" => "Break or rest at regular intervals of work",
		"1" => "Use of pallet jacks or other lifting aid",
		"2" => "Manual lifting of no more than 25kg",
		"3" => "Buddy system adopted for manual lifting",
		"4" => "Refer to SWP-Ergonomics"
		),
	"p_l_p" => array(
		"0" => "Break or rest at regular intervals of work",
		"1" => "Use of pallet jacks or other lifting aid",
		"2" => "Manual lifting of no more than 25kg",
		"3" => "Buddy system adopted for manual lifting",
		"4" => "Refer to SWP-Ergonomics for proper lifting posture"
		),
	"i_c_a_w" => array(
		"0" => "Proper briefing/planning prior to start of lifting activity",
		"1" => "Ensure no communication barrier between workers involved",
		"2" => "Wearing of Safety shoes",
		"3" => "Ensure load is properly secured or rigged during transportation"
		),
	"u_p_g_c_d_t_o_m" => array(
		"0" => "Proper briefing/planning prior to start of lifting activity",
		"1" => "Wearing of Safety shoes",
		"2" => "Ensure load is properly secured or rigged during transportation",
		"3" => "No standing under or near suspended load",
		"4" => "Ensure ground conditions are solid and even",
		"5" => "Regular briefing to remind workers on existing control measures",
		"6" => "Use of lifting equipment whenever possible",
		"7" => "RA briefing",
		"8" => "TBM Talks"
		),
	"t_u_o_s_m" => array(
		"0" => "Buddy system when carrying object",
		"1" => "Use mechanical lifting aids, e.g. gantry crane, pallet jack, etc. whenever available",
		"2" => "Manual lifting of no more than 25kg",
		"3" => "Scaffolds/ladders or MEWP to retrieve load at height"
		),
	"c_o_l_i_c_a" => array(
		"0" => "Buddy system when carrying object",
		"1" => "Warning signs and traffic marshall to be deployed to move the crowd",
		"2" => "Manual lifting of no more than 25kg", 
		"3" => "Use mobile scaffolds/ladders or MEWP to retrieve load at height",
		"4" => "Wearing Safety shoes and anti slip safety gloves"
		),
	"s_o_p_a_h" => array(
		"0" => "Heaviest load to be stored at the lowest point",
		"1" => "Racks and shelves are designed to withstand the load",
		"2" => "Safe Working Load (SWL) is displayed on the shelves. Do not overload the racks/shelves",
		"3" => "Ensure products are secured on shelf",
		"4" => "No standing under or near suspended load during lifting or hoisting of product",
		"5" => "Use mechanical lifting aids, e.g. gantry crane, pallet jack, forklift etc. whenever available",
		"6" => "Use mobile scaffolds/ladders or MEWP to retrieve load at height",
		),
	"s_o_h_t" => array(
		"0" => "Handler to wear safety boots",
		"1" => "Ensure products are secured in container / shelf",
		"2" => "Use mobile scaffolds/ladders or MEWP to retrieve tools at height",
		),
	"s_o_c_m" => array(
		"0" => "No smoking in the storage area",
		"1" => "No heat source or hot work shall be done near storage area",
		"2" => "Fire extinguisher to be provided",
		"3" => "Fire blanket to be provided",
		"4" => "No compatible works allowed",
		"5" => "Briefing of SWP-Storage",
		),
	"p_h_o_s_a" => array(
		"0" => "Regular inspection on work area",
		"1" => "Practice regular housekeeping",
		"2" => "Supervisors to do daily inspection",
		"3" => "No smoking in the storage area",
		"4" => "No combustible materials to be stored near heat source",
		"5" => "Fire extinguisher to be provided",
		"6" => "Fire blanket to be provided",
		"7" => "No compatible works allowed",
		"8" => "Refer to SWP-Storage",
		),
	"f_p_d_c_p" => array(
		"0" => "Wearing of safety goggles",
		"1" => "Regular briefing to remind workers on the hazards",
		"2" => "Refer to SWP-Hand Tools Safety", 
		"3" => "Designate work area for cutting process activity",
		"4" => "Demarcate work area",
		),
	"e_h_f_u_e_h_d" => array(
		"0" => "All electrical tools/equipments are to be inspected by LEW on a periodic basis",
		"1" => "Use of electrical tools/equipments are to be used with inspected ELCB",
		),
	"n_p_d_w" => array(
		"0" => "Contain noise at source",
		"1" => "Install noise barrier at source",
		"2" => "Purchase hand tools with noise reduction features",
		"3" => "Routine maintenance of the equipment",
		"4" => "Test of work noise level if noisy work has to be carried out",
		"5" => "Use of ear plugs ",
		),
	"i_p_m_o_h_t" => array(
		"0" => "Check the condition of equipment before use",
		"1" => "Report any damaged cables to supervisor",
		"2" => "Do not attempt to do own repair",
		"3" => "Worker to wear gloves",
		"4" => "Monthly LEW inspection",
		),
	"v_h_f_c_i_o_v_o_o" => array(
		"0" => "Operator must be trained, certified and competent to operate forklift",
		"1" => "Designated path to be arranged and briefed to all operator",
		"2" => "Banksman to be deployed to guide forklift",
		),
	"s_o_v_b_h_f" => array(
		"0" => "Horn the forklift to alert the personnel walking at surrounding area.",
		"1" => "Any reversing shall be overseen by a trained banks man  ",
		"2" => "Ensure routine inspection for forklift horn and reverse alarms",
		),
	"o_f_f_t_f" => array(
		"0" => "The load shall be secured before any movement.",
		"1" => "Operator must be trained, certified and competent to operate forklift",
		"2" => "Forklift speed limiter not bypassed",
		),
	"u_f_o" => array(
		"0" => "To ensure the seat belts is engaged and complied before operating.",
		"1" => "Close supervision", 
		),
	"f_i_a_i" => array(
		"0" => "Drivers are not allowed to leave the vehicle engine running when not in operation.",
		"1" => "The spark arrestor shall be installed onto the exhaust pipe. ",
		"2" => "Routine maintenance to be carried out for the forklift",
		),
	"w_a_h" => array(
		...
		"7" => "Install vertical lifeline with anchorage designed by PE",
	...
	"f_i_o_i_s_a" => array(
		"0" => "Ensure load is within SWL of lifting equipment",
		"1" => "Ensure proper communication & co-ordination with eye contact during the lifting operation",
		"2" => "Load to be secured before operating the forklift",
		),
	"w_a_h_b_s" => array(
		"0" => "Donned safety harness with 100% tie off",
		"1" => "Ensure boomlift door and handrail are in good condition",
		"2" => "Check the maintenance report of the boomlift",
		"3" => "Ensure lifting platform is inspected by authorised examiner. (valid LP cert)",
		"4" => "Operators are trained to use the MEWP",
		"5" => "Proper demarcation to be in placed to warn others of the activities",
		...
		"15" => "Only authorized operator are allowed to operate machine. LOA on display for inspection",
		"16" => "Chain or gate shall be closed after the operator enter the machine",
		),
	"o_r_t_m" => array(
		"0" => "Install pipe(taller than worker) on boomlift to prevent worker from hitting the ceiling",
		"1" => "Watchman to look out for the operator ",
		),
	"i_p_o_m_o_t_m" => array(
		"0" => "Material that exceed the length of the MEWP shall be secured before lifting",
		"1" => "Use of  other lifting machine to lift the material", 
		),
	"f_o_l_g" => array(
		"0" => "Lifting gear must be inspected at registered with MOM with valid certificate",
		"1" => "Lifting supervisor shall inspect the lifting gear before use",
		"2" => "Lifting gear shall only be used for lifting purpose only",
		"3" => "Monthly inspection shall be carried out on the lifting gears",
		"4" => "Use within the SWL of the lifting gear",
		),
	"o_o_l_m" => array(
		"0" => "Trained operator",
		"1" => "Lifting Supervisor shall be aware of the SWL of the lifting machine",
		"2" => "Competent lifting team to oversee the lifting operation",
		"3" => "Permit to work shall be approved before start of lifting operation",
		"4" => "Lifting plan shall be prepared and approved",
		),
	"i_r_o_l" => array(
		"0" => "Competent rigger man to perform rigging operation",
		"1" => "Lifting zone to be demarcated and warning signs to be provided",
		"2" => "Lifting supervisor to inspect on the rigging method after the rigger has done rigging",
		"3" => "Lifting supervisor to ensure that no one is standing under the suspended load",
		),
	"u_u_g_f_l_o" => array(
		"0" => "Steel plate shall be used for outrigger",
		"1" => "Permit to work system must be complied for lifting operation",
		"2" => "Lifting supervisor and crane operator shall inspect the lifting area ",
		),
	"i_t_c_d_t_g_t_l_e" => array(
		"0" => "Ensure adequate number of traffic controllers to direct traffic.",
		"1" => "Only appointed traffic controller to guide the lorry movement.",
		"2" => "Traffic Controller to be equipped with traffic marshalling peripherals",
		"3" => "Large reflective gloves",
		"4" => "Flashing batons",
		"5" => "Stop / Go signs etc.",
		"6" => "Provide safety signage along the gate to create awareness for the driver.",
		 "7" => "Provide additional number of traffic controllers to guide / control the public movement near to vehicle access area.",
		"8" => "Provide directional signage to traffic controllers guiding the lorry movement at the access and within the site.",
		),
	"l_d_a_f_f_l_b_w_l" => array(
		"0" => "Operators / Supervisors to ensure all loads are strapped down / adequately and securely before lorry / lorry crane is instructed to move off.",
		"1" => "Banksman to be posted to direct heavy vehicles.",
		"2" => "Banksman to be issued with high visibility vests",
		"3" => "Banksman to be issued with whistles (auditory alarm) to warn others",
		"4" => "Banksman to ensure no-one is standing alongside the lorry or kept to a 1m safety distance away",
		),
	"t_o_m_f_t" => array(
		"0" => "Machineries to be secured properly on the trailer",
		"1" => "Supervisor must ensure the trailer to be parked on firm ground.",
		"2" => "Provide banks man to guide the operator during loading / unloading.",
		"3" => "Excavator operator / operator must be competent in loading & unloading of materials.",
		),
	"d_t" => array(
		"0" => "Workers are to ensure the head of hammer is firmly attached to the handles.",
		"1" => "Supervisors are to ensure workers do not redress, grind weld or reheat-treat a hammer head",
		"2" => "Supervisors must discard any hammer with mushroomed or chipped face with cracks in the handle",
		"3" => "Workers to replace loose, cracked or splintered handles",
		"4" => "Supervisors are to ensure workers wearing appropriate PPE e.g. (Safety-goggles/glasses, gloves) when they are doing hammering works.",
		),
	"m_o_h" => array(
		"0" => "Workers  are to ensure the head of hammer is firmly attached to the handles",
		"1" => "Supervisors  are to ensure workers do not redress, grind weld or reheat-treat a hammer head",
		...
		"3" => "Workers  to replace loose, cracked or splintered handles",
		"4" => "Supervisors are to ensure workers wearing appropriate PPE e.g. (Safety-goggles/glasses, gloves) when they are doing hammering works.",
		"5" => "Workers to ensure to watch the object they are hitting",
		"6" => "Workers to ensure look behind and above before you swinging the hammer",
		"7" => "Supervisors to brief the workers to use his whole arm and elbow and not just rely ",
		),
	"f_o_w_w_o_t" => array(
		"0" => "Loose materials, hand tools to be keep in the toolbox",
		"1" => "Demarcate work area to prevent worker standing/walking pass work area",
		),
	"s_o_h_b_p_p" => array(
		"0" => "The affected area to be cordon off and warning signs to be displayed",
		"1" => "A watchman to be standby for monitoring",
		"2" => "Ensure all the pipes to be tested are secured.",
		"3" => " Ensure the pipes are not over-pressurized",
		"4" => " Ensure correct blind is used & tightened properly.",
		"5" => "Wear appropriate PPE, e.g. safety glass & hand gloves.",
		"6" => "Check for leakage prior testing",
		"7" => "Install the pressure safety relief valves",
		"8" => "The pressure is increasing gradually by 50% each interval.",  
		"9" => "The mustering point is designated and free from obstruction",
		"10" => "Ensure the pressure is closed monitored and no over pressure due to thermal expansion. ",
		),
	"i_p_p_w" => array(
		"0" => "Testing instruments must be calibrated and valid",
		"1" => "To use only Multi Mate & test pen to check circuits",
		"2" => "Only trained and competent person to carry out the testing",
		),
	"w_o_e" => array(),
	"w_a_h_l" => array(
	...
	"p_h_s_o" => array(
				...
				"8" => "Onsite supervison and frequent inspection and training",
				),
	...
	"e_m_m_p_p" => array(
		...
		"8" => "Look out for pinch point and tape it with warning signs",
		"9" =>	"Install guard to prevent fingers from getting near",
		"10" =>	"Provide proper handle for material that require lifting",
		"11" =>	"Use of equipment or tools to aid the process",
		"12" =>	"Training must be provided to the workers handling such equipment or tools",
		),
	"c_h_s" => array(
