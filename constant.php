...
$existing_risk_control=array(
	...
	"e_m_m_p_p" => array(
		...
		"8" =>	"Install guard to prevent fingers from getting near",

		"9" =>	"Provide proper handle for material that require lifting",
		"10" =>	"Use of equipment or tools to aid the process",
		"11" =>	"Training must be provided to the workers handling such equipment or tools",
		),
	"c_h_s" => array(
