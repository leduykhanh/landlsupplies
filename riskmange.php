...
define('NON_ACTIVE', 0);
 ...
 if(isset($_GET['riskid']) && $_GET['riskid'] != '')
 ...
 else
  {
     ...
     $riskassessment = "INSERT INTO `riskassessment` (`id`, `createdBy`, `location`, `process`, `createdDate`, `approveDate`, `revisionDate`, `approveBy`, `status`,`expiry_date`) VALUES (NULL, '".$_SESSION['adminid_landsupplies']."', '".$_POST['location']."', '".$_POST['process']."', '".$creationDate."', NULL, '".$creationDate."', NULL, '".$status."',".$_POST["expiry_date"].");";
